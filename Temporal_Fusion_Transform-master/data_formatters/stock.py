...
# Lint as: python3
"""Custom formatting functions for Stcok dataset.
...
class StockFormatter(GenericDataFormatter):
  ...
  _column_definition = [
      ...
      ('value', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('n_stock', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('foreign_vol', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('agency_buy', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ('agency_netbuy', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
      ...
      ('section', DataTypes.CATEGORICAL, InputTypes.STATIC_INPUT)
  ]
  ...
  def set_scalers(self, df, enable_scaling=False):
      ...
      self._real_scalers = sklearn.preprocessing.StandardScaler(with_mean=enable_scaling, with_std=enable_scaling).fit(
          data)
